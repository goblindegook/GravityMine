...
class GFRedmineData
{
    ...
    public static function get_redmine_table_name ()
    {
        global $wpdb;
        return $wpdb->prefix . "rg_redmine";
    }

    public static function update_table ()
    {
        global $wpdb;
        $table_name = self::get_redmine_table_name();
    ...
    {
        global $wpdb;
        $wpdb->query( "DROP TABLE IF EXISTS " . self::get_redmine_table_name() );
    }
